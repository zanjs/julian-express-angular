'use strict';
describe('module julian.settings',function () {
	...
	beforeEach(module('julian.resources'));
	beforeEach(module('julian.service'));
	beforeEach(module('julian.settings'));
	beforeEach(module('templates'));
		...
		describe('SettingCtrl',function () {
			...
			it('should mdUser return success',function () {
				...
				$scope.mdUser(form);
				$httpBackend.flush();
				expect($scope.user.nickname).toBe('Julian');
			});
		});
